...
d.addEventListener("DOMContentLoaded", (e) => {
  ...
  localStorage.setItem("TITULO_Serie", "El secreto de sus ojos");
...
function describir_peliculas(idContainer, ruta) {
  ...
  fetch(ruta)
    ...
    .then(function(data) {
      ...
      localStorage.setItem("URL_Serie", pelicula_especifica.link); //Guardamos el valor de la pelicula en el localstorage
      localStorage.setItem("TITULO_Serie", pelicula_especifica.titulo); //Guardamos el valor del titulo en el localstorage
        const cardHTML = `
...
function ver_pelicula() {
  ...
  d.addEventListener("click", e => {
    if (e.target.matches("#ver-pelicula")) {
      const pelicula = localStorage.getItem("URL_Serie");
  ...
  let genero_de_la_imagen = "img_" + genero;
    d.addEventListener("click", e => {
      if (e.target.matches(`#${genero_de_la_imagen}_1`)) {
        ...
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_1`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_2`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_2`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_3`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_3`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_4`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_4`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_5`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_5`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_6`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_6`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_7`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_7`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_8`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_8`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_9`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_9`, "../JS/series.json");
      }
      else if (e.target.matches(`#${genero_de_la_imagen}_10`)) {
        background_video.classList.add('noDisplay');
        background_image.classList.remove('noDisplay');
        describir_peliculas(`${genero}_10`, "../JS/series.json");
      }
      else {
